            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    if(name.equals("") && email.equals("") && phone.equals("") && desig.equals("")) {
                        ...
                        UtilsShop.ShortToast(context, "Please enter a valid email address");
                    }
                    else {
                            ...
                            public void onResponse(String response) {
                                try {
                                    if (response.equalsIgnoreCase("success")) {
                                        ...
                                        Toast.makeText(context, "Employee Could Not be Added due to some problem. Please Try Again.", Toast.LENGTH_SHORT).show();
                                    }
                                } catch (Exception e) {
