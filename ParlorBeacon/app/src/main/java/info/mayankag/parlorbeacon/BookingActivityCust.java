    ...
    public void book(View view) {
        ...
        if (!UtilsCust.isNetworkAvailable(this)) {
            ...
            if (!name.equals("") && !email.equals("") && !phone.equals("") && !date.equals("")) {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            if (response.equals("Success")) {
                                ...
                                UtilsCust.ShortToast(BookingActivityCust.this, getString(R.string.booking_cust_fail_text));
                        } catch (Exception e) {
                ...
                Toast.makeText(BookingActivityCust.this, getString(R.string.fill_all_details_text), Toast.LENGTH_SHORT).show();
        }
    }
